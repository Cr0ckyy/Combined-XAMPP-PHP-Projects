    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                // Sets the attributes of #bg element for to the selected image
                $("#bg").attr("src", "images/thesopranos.jpg");

                // Sets the CSS of #bg element for to the selected image
                $("#bg").css({"object-fit": "scale-down", "width": "100%", "height": "100%"});

                // Sets the CSS of images being displayed
                ...
                $("[type=checkbox]").click(function () {
                    ...
                    // Sets the value of #results element
                    $("#results").val(message);
                });
                ...
                // when the #music element is clicked
                $("#b4").click(function () {
